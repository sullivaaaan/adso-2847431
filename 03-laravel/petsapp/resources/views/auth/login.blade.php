...
@section('content')
    ...
    <form method="post" action="{{ route('login') }}">
        ...
        <fieldset class="fieldset w-sm bg-base-200 border border-base-300 p-4 rounded-box">
                ...
                <input type="email" name="email" class="input rounded-full" placeholder="Email" />
                
                <label class="fieldset-label">Password</label>
                <input type="password" name="password" class="input rounded-full" placeholder="Password" />
                
                <button class="btn mt-4 rounded-full text-white bg-cyan-800">Login</button>
        </fieldset>
    </form>
@endsection
